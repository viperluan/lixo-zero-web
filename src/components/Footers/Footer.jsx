    ...
    <Fragment>
      <Container>
        ...
        <Row className="text-center mt-4">
          <Col>
            <a
              href="https://www.facebook.com/caxiaslixozero/"
              target="_blank"
            ...
            <a
              href="https://chat.whatsapp.com/ESseckd56xx7WG5iM8PJRK"
              target="_blank"
              rel="noopener noreferrer"
              style={iconStyle}
            >
            ...
            <a
              href="https://www.youtube.com/@caxiaslixozero5980"
              target="_blank"
              rel="noopener noreferrer"
              style={iconStyle}
            >
            ...
            <a
              href="https://www.instagram.com/caxiaslixozero/"
              target="_blank"
              rel="noopener noreferrer"
              style={iconStyle}
            >
