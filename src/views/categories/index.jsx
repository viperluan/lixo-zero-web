...
const CategoriesContainer = () => {
    ...
    const fetchCategories = (page) => {
        setIsLoading(true)
        api.get(`/categorias?page=${page}&limit=10`).then((res) => {
    ...
    return (
        <Fragment>
            ...
            <CategoriesRegister isOpen={openModal} toogleModal={toogleModal} callBack={() => { fetchCategories(1) }} />
            <Card>
                <CardBody>
                    <Row>
                        <div className="col">
                            <Card className="shadow">
                                <CardHeader className="border-0 d-flex justify-content-between">
                                    ...
                                    <Button onClick={() => setOpenModal(!openModal)} color="primary">Nova Categoria</Button>
                                </CardHeader>
